 ...
 * Description: Makes modules connected for E2E tests based on a cookie set by the Playwright fixture.
 *
...
function e2e_get_connected_modules() {
	...
	$raw_modules = sanitize_text_field( wp_unslash( $_COOKIE[ E2E_CONNECTED_MODULES_COOKIE ] ) );
