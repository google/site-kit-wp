...
class Create_PublicationTest extends TestCase {
	...
	public function test_create_request() {
		...
		$this->assertSame(
			'https://webcontentpublisher.googleapis.com/v1/organizations/organization-1/publications',
		...
		$this->assertJsonStringEqualsJsonString(
			wp_json_encode(
				array(
					'displayName'   => 'Example Publication',
					'languageCode'  => 'en',
					'primaryDomain' => array( 'url' => 'https://example.com' ),
					'regionCode'    => 'US',
				)
			),
	...
	public function test_parse_response() {
		...
		$this->assertSame( 'publication-1', $publication->getPublicationId(), 'The response should contain the created publication.' );
		$this->assertSame( 'ONBOARDING_COMPLETE', $publication->getOnboardingState(), 'The response should be normalized.' );
	}
