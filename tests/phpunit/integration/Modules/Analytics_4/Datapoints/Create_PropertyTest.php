...
class Create_PropertyTest extends TestCase {
	...
	public function set_up() {
		...
		FakeHttp::fake_google_http_handler(
			...
			function ( Request $request ) {
				...
				$response = new Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaProperty();
	...
	public function test_create_request() {
		...
		$property_request = new Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaProperty( json_decode( $this->create_property_request->getBody()->getContents(), true ) );
