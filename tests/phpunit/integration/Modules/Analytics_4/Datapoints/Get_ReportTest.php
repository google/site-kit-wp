...
class Get_ReportTest extends TestCase {
	...
	public function set_up() {
		...
		$is_shared_request_method->setAccessible( true );
		...
		$this->datapoint = new Get_Report(
			array(
				...
				'context'           => $context,
				'is_shared_request' => function ( $datapoint ) use ( $is_shared_request_method ) {
					return $is_shared_request_method->invoke( $this->analytics, $datapoint );
				},
			),
		);
