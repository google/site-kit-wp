...
class Report_Data_ProcessorTest extends TestCase {
	 ...
	 * @return array Row holding its dimension values and its metric values.
	 */
	...
	public function test_sum_metric_by_group__adds_every_row_to_one_group_when_the_dimension_is_an_empty_string() {
		...
		$this->assertSame(
			...
			'sum_metric_by_group() should put every event name in one group, with a total for each date range.'
		);
	}
