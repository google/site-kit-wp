...
class Advanced_TrackingTest extends TestCase {
	...
	public function test_register() {
		...
		remove_all_actions( 'googlesitekit_analytics_4_init_tag' );
		remove_all_actions( 'googlesitekit_analytics_4_init_tag_amp' );

		$advanced_tracking->register();

		$this->assertTrue( has_action( 'googlesitekit_analytics_4_init_tag' ) );
		$this->assertTrue( has_action( 'googlesitekit_analytics_4_init_tag_amp' ) );

		remove_all_actions( 'wp_footer' );
		do_action( 'googlesitekit_analytics_4_init_tag', 'G-1A2BCD345E' );
		$this->assertTrue( has_action( 'wp_footer' ) );

		remove_all_filters( 'googlesitekit_amp_gtag_opt' );
		do_action( 'googlesitekit_analytics_4_init_tag_amp', 'G-1A2BCD345E' );
