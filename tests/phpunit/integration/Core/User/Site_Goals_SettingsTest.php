...
class Site_Goals_SettingsTest extends TestCase {
	...
	public function test_get_default() {
		$this->assertEquals( array(), $this->site_goals_settings->get(), 'The default value should be an empty array.' );
	}
	...
	public function test_merge__saves_goal_drivers_and_visitor_engagement() {
		...
		$this->assertEqualSetsWithIndex( $settings, $this->site_goals_settings->get(), 'The merged goalDrivers and visitorEngagement should be persisted.' );
	}
	...
	public function test_merge__preserves_existing_settings() {
		...
		$this->assertEqualSetsWithIndex(
			...
			'A partial merge of visitorEngagement should preserve the existing goalDrivers.'
		);
	}
	...
	public function test_merge__ignores_unknown_keys() {
		...
		$this->assertEqualSetsWithIndex(
			...
			$this->site_goals_settings->get(),
			'Unknown keys should be stripped from the merged settings.'
		);
	}
	...
	public function test_merge__ignores_null_values() {
		...
		$this->assertEqualSetsWithIndex(
			...
			$this->site_goals_settings->get(),
			'A null value for an existing key should be ignored, preserving the prior value.'
		);
	}
