...
storiesOf( 'AdSense Module/Setup', module )
	.add( 'Loading', ( args, { registry } ) => {
		registry.dispatch( MODULES_ADSENSE ).receiveGetSettings( defaultSettings );
	...
	.add( 'AdBlocker active', ( args, { registry } ) => {
		...
		registry.dispatch( MODULES_ADSENSE ).receiveGetClients( fixtures.clients, { accountID: fixtures.accounts[ 0 ]._id } );
		registry.dispatch( MODULES_ADSENSE ).receiveGetAlerts( [], { accountID: fixtures.accounts[ 0 ]._id } );
	...
	.add( 'No account (existing tag)', ( args, { registry } ) => {
		registry.dispatch( MODULES_ADSENSE ).receiveGetSettings( defaultSettings );
		registry.dispatch( MODULES_ADSENSE ).receiveIsAdBlockerActive( false );
		registry.dispatch( MODULES_ADSENSE ).receiveGetExistingTag( 'ca-pub-123456789' );
		registry.dispatch( MODULES_ADSENSE ).finishResolution( 'getAccounts', [] );
		registry.dispatch( MODULES_ADSENSE ).receiveError( {
			// Typically thrown when fetching accounts.
			message: 'No account.',
	...
	.add( 'Multiple accounts', ( args, { registry } ) => {
		...
		registry.dispatch( MODULES_ADSENSE ).receiveGetClients( fixtures.clients, { accountID: fixtures.accountsMultiple[ 0 ]._id } );
		...
		registry.dispatch( MODULES_ADSENSE ).receiveGetAlerts( [], { accountID: fixtures.accountsMultiple[ 0 ]._id } );
		registry.dispatch( MODULES_ADSENSE ).receiveGetAlerts( [], { accountID: fixtures.accountsMultiple[ 1 ]._id } );
		registry.dispatch( MODULES_ADSENSE ).receiveGetURLChannels( [], {
	...
	.add( 'Graylisted account', ( args, { registry } ) => {
		...
		registry.dispatch( MODULES_ADSENSE ).receiveGetAccounts( fixtures.accounts );
		registry.dispatch( MODULES_ADSENSE ).receiveGetClients( fixtures.clients, { accountID: fixtures.accounts[ 0 ]._id } );
		registry.dispatch( MODULES_ADSENSE ).receiveGetAlerts( fixtures.alertsGraylisted, { accountID: fixtures.accounts[ 0 ]._id } );
		registry.dispatch( MODULES_ADSENSE ).receiveGetURLChannels( [], {
			accountID: fixtures.accounts[ 0 ]._id,
			clientID: fixtures.clients[ 0 ]._id,
		} );
	...
	.add( 'Pending account', ( args, { registry } ) => {
		...
		registry.dispatch( MODULES_ADSENSE ).receiveGetAccounts( fixtures.accounts );
		registry.dispatch( MODULES_ADSENSE ).receiveGetClients( fixtures.clients, { accountID: fixtures.accounts[ 0 ]._id } );
		registry.dispatch( MODULES_ADSENSE ).finishResolution( 'getAlerts', [ fixtures.accounts[ 0 ]._id ] );
		registry.dispatch( MODULES_ADSENSE ).receiveError( {
	...
	.add( 'Account without AFC client (AdMob)', ( args, { registry } ) => {
		...
		registry.dispatch( MODULES_ADSENSE ).receiveGetExistingTag( null );
		registry.dispatch( MODULES_ADSENSE ).receiveGetAccounts( fixtures.accounts );
		registry.dispatch( MODULES_ADSENSE ).receiveGetClients( fixtures.clientsNoAFC, { accountID: fixtures.accounts[ 0 ]._id } );
		registry.dispatch( MODULES_ADSENSE ).receiveGetAlerts( fixtures.alerts, { accountID: fixtures.accounts[ 0 ]._id } );
	...
	.add( 'Newly approved account (existing tag with permission)', ( args, { registry } ) => {
		...
		registry.dispatch( MODULES_ADSENSE ).receiveIsAdBlockerActive( false );
		registry.dispatch( MODULES_ADSENSE ).receiveGetExistingTag( fixtures.clients[ 0 ]._id );
	...
	.add( 'Site not added', ( args, { registry } ) => {
		registry.dispatch( MODULES_ADSENSE ).receiveGetSettings( accountCompleteSettings );
		registry.dispatch( MODULES_ADSENSE ).receiveIsAdBlockerActive( false );
		registry.dispatch( MODULES_ADSENSE ).receiveGetExistingTag( null );
		registry.dispatch( MODULES_ADSENSE ).receiveGetAccounts( fixtures.accounts );
		registry.dispatch( MODULES_ADSENSE ).receiveGetClients( fixtures.clients, { accountID: fixtures.accounts[ 0 ]._id } );
