...
final class Timezones {
	 ...
	 *
	 * Provides the same data as the dropdown generated by core's `wp_timezone_choice`.
	 *
	 * @todo Consider using https://github.com/unicode-org/cldr/blob/master/common/bcp47/timezone.xml after API testing.
	 *
	 * @since 1.0.0
