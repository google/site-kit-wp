	...
	<tr>
		<td class="card" style="background-color: #FFFFFF; border-radius: 16px; padding: 16px;">
			...
			<table role="presentation" width="100%" style="margin-bottom:16px;">
				<tr>
					<td class="text-secondary" style="font-size:12px; line-height:16px; font-weight:500; color:#6C726E;">
						<?php echo esc_html( $section_parts['total_conversion_events']['data']['label'] ); ?>
					</td>
					<td class="text-secondary subtitle" width="110" style="font-size:12px; line-height:16px; font-weight:500; color:#6C726E; text-align: right; width: 110px;">
						<?php echo esc_html( $section_parts['total_conversion_events']['data']['change_context'] ); ?>
					</td>
				</tr>
				<tr>
					<td class="text-primary" style="font-size:14px; line-height:20px; font-weight:500;">
