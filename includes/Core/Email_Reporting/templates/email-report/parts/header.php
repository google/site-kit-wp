 ...
 * @var array    $header_notices Header notice payloads.
 * @var callable $get_asset_url Function to generate asset URLs.
 * @var callable $render_part   Function to render template parts.
 */
...
<?php if ( ! empty( $header_notices ) ) : ?>
	<?php foreach ( $header_notices as $notice ) : ?>
		<?php
		$render_part(
			'notice',
			array(
