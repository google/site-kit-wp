...
<table role="presentation" width="100%" style="margin-bottom:16px;">
	<tr>
		...
		<td>
			<div class="text-primary" style="font-size:16px; line-height:24px; font-weight:500; margin-bottom:5px;">
				<?php echo esc_html( $label ); ?>
			</div>

			<table role="presentation" width="100%" class="border"
				style="padding-bottom: 10px; border-bottom: 1px solid #EBEEF0; margin-bottom: 10px;">
				<tr>
					<td class="text-secondary" style="font-size:12px; font-weight:500; color:#6C726E; text-align: left; padding-bottom: 8px;">
						<?php
						printf(
			...
			<div class="text-secondary" style="font-size:12px; line-height:16px; font-weight:500; color:#6C726E; margin-bottom:4px;">
