<?php
/**
 * Class Google\Site_Kit\Core\Authentication\Connected_Proxy_SiteURL
 *
...
/**
 * Connected_Proxy_SiteURL class.
 *
 * @since 1.17.0
 * @access private
 * @ignore
 */
class Connected_Proxy_SiteURL extends Setting {

	/**
	 * The option_name for this setting.
	 */
	const OPTION = 'googlesitekit_connected_proxy_siteurl';
