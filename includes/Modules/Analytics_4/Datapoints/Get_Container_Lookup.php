<?php
/**
 * Class Google\Site_Kit\Modules\Analytics_4\Datapoints\Get_Container_Lookup
 *
 ...
 * @ignore
 */
class Get_Container_Lookup extends Datapoint implements Executable_Datapoint {
	...
	public function create_request( Data_Request $data ) {
		...
		return $this->get_service()->accounts_containers->lookup( array( 'destinationId' => $data['destinationID'] ) );
	}
	 ...
	 * @param Data_Request $data     Data request object.
	 * @return Container The GTM Container.
	 */
