...
class Web_Tag extends Module_Web_Tag {
	...
	protected function update_the_content( $content ) {
		...
		$cta_placeholder = '<div><div counter-button style="height: 34px; visibility: hidden; box-sizing: content-box; padding: 12px 0; display: inline-block; overflow: hidden;"></div><button twg-button style="height: 42px; visibility: hidden; margin: 12px 0;"></button></div>';
