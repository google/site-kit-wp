<?php
/**
 * Class Google\Site_Kit\Modules\AdSense\Datapoints\Get_Alerts
 *
...
/**
 * Class for the alerts listing datapoint.
 *
 * @since 1.190.0
 * @access private
 * @ignore
...
class Get_Alerts extends AdSense_Datapoint implements Executable_Datapoint {
	...
	public function create_request( Data_Request $data_request ) {
		...
		return $service->accounts_alerts->listAccountsAlerts( AdSense::normalize_account_id( $data_request->data['accountID'] ) );
	}
	/**
	 * Parses a response.
	 *
