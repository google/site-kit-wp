<?php
/**
 * Class Google\Site_Kit\Modules\Ads\Conversion_Tracking\Event
 *
...
namespace Google\Site_Kit\Modules\Ads\Conversion_Tracking;

use Exception;

/**
 * Class for representing a single tracking event that Conversion_Tracking tracks.
 *
 * @since n.e.x.t
 * @access private
 * @ignore
