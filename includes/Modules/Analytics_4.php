	...
	protected function create_data_request( Data_Request $data ) {
		switch ( "{$data->method}:{$data->datapoint}" ) {
			...
			case 'POST:create-custom-dimension':
				...
				isset( $custom_dimension_data['description'] ) && $custom_dimension->setDescription( $custom_dimension_data['description'] );
				isset( $custom_dimension_data['disallowAdsPersonalization'] ) && $custom_dimension->setDisallowAdsPersonalization( $custom_dimension_data['disallowAdsPersonalization'] );
