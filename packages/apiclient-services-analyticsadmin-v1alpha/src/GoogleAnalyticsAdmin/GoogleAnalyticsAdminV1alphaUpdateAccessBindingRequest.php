...
class GoogleAnalyticsAdminV1alphaUpdateAccessBindingRequest extends \Google\Model
{
...
class_alias(GoogleAnalyticsAdminV1alphaUpdateAccessBindingRequest::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaUpdateAccessBindingRequest');
