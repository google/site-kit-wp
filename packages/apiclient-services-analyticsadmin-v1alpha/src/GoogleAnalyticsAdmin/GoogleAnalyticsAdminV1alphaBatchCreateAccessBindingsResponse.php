...
class GoogleAnalyticsAdminV1alphaBatchCreateAccessBindingsResponse extends \Google\Collection
{
...
class_alias(GoogleAnalyticsAdminV1alphaBatchCreateAccessBindingsResponse::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaBatchCreateAccessBindingsResponse');
