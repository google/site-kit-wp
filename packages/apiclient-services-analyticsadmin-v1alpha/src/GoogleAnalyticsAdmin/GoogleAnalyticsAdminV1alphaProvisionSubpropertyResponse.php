...
class GoogleAnalyticsAdminV1alphaProvisionSubpropertyResponse extends \Google\Model
{
...
class_alias(GoogleAnalyticsAdminV1alphaProvisionSubpropertyResponse::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaProvisionSubpropertyResponse');
