...
class GoogleAnalyticsAdminV1alphaGroupingRule extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(GoogleAnalyticsAdminV1alphaGroupingRule::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaGroupingRule');
