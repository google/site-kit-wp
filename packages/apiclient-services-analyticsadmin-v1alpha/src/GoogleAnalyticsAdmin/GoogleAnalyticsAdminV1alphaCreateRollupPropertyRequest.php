...
class GoogleAnalyticsAdminV1alphaCreateRollupPropertyRequest extends \Google\Collection
{
...
class_alias(GoogleAnalyticsAdminV1alphaCreateRollupPropertyRequest::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaCreateRollupPropertyRequest');
