...
class GoogleAnalyticsAdminV1alphaChannelGroupFilter extends \Google\Model
{
  /**
   * @var string
   */
  ...
  /**
   * @param GoogleAnalyticsAdminV1alphaChannelGroupFilterInListFilter
   */
  ...
  /**
   * @return GoogleAnalyticsAdminV1alphaChannelGroupFilterInListFilter
   */
  ...
  /**
   * @param GoogleAnalyticsAdminV1alphaChannelGroupFilterStringFilter
   */
  ...
  /**
   * @return GoogleAnalyticsAdminV1alphaChannelGroupFilterStringFilter
   */
...
class_alias(GoogleAnalyticsAdminV1alphaChannelGroupFilter::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaChannelGroupFilter');
