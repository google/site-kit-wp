...
class GoogleAnalyticsAdminV1alphaChannelGroupFilterExpressionList extends \Google\Collection
{
...
class_alias(GoogleAnalyticsAdminV1alphaChannelGroupFilterExpressionList::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaChannelGroupFilterExpressionList');
