...
class GoogleAnalyticsAdminV1alphaBatchGetAccessBindingsResponse extends \Google\Collection
{
...
class_alias(GoogleAnalyticsAdminV1alphaBatchGetAccessBindingsResponse::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaBatchGetAccessBindingsResponse');
