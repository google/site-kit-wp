...
class GoogleAnalyticsAdminV1alphaListExpandedDataSetsResponse extends \Google\Collection
{
  protected $collection_key = 'expandedDataSets';
  protected $expandedDataSetsType = GoogleAnalyticsAdminV1alphaExpandedDataSet::class;
...
class_alias(GoogleAnalyticsAdminV1alphaListExpandedDataSetsResponse::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaListExpandedDataSetsResponse');
