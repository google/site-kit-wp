...
class GoogleAnalyticsAdminV1alphaSubpropertyEventFilterClause extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(GoogleAnalyticsAdminV1alphaSubpropertyEventFilterClause::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaSubpropertyEventFilterClause');
