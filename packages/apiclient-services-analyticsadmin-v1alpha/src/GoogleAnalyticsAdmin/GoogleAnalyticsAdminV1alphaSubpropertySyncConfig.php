...
class GoogleAnalyticsAdminV1alphaSubpropertySyncConfig extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(GoogleAnalyticsAdminV1alphaSubpropertySyncConfig::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaSubpropertySyncConfig');
