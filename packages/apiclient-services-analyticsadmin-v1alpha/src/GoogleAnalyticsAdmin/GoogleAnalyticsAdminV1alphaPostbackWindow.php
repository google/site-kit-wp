...
class GoogleAnalyticsAdminV1alphaPostbackWindow extends \Google\Collection
{
  ...
  /**
   * @param GoogleAnalyticsAdminV1alphaConversionValues[]
   */
...
class_alias(GoogleAnalyticsAdminV1alphaPostbackWindow::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaPostbackWindow');
