...
class GoogleAnalyticsAdminV1alphaBatchUpdateAccessBindingsResponse extends \Google\Collection
{
...
class_alias(GoogleAnalyticsAdminV1alphaBatchUpdateAccessBindingsResponse::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaBatchUpdateAccessBindingsResponse');
