...
class GoogleAnalyticsAdminV1alphaListEventCreateRulesResponse extends \Google\Collection
{
...
class_alias(GoogleAnalyticsAdminV1alphaListEventCreateRulesResponse::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaListEventCreateRulesResponse');
