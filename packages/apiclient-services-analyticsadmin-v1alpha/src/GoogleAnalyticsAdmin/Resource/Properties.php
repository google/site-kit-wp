...
use Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaReportingIdentitySettings;
...
use Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaSubmitUserDeletionRequest;
use Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaSubmitUserDeletionResponse;
...
class Properties extends \Google\Service\Resource
{
   ...
   *
   * @param string $name Required. The name of the property to submit user
   * deletion for.
   * @param GoogleAnalyticsAdminV1alphaSubmitUserDeletionRequest $postBody
   * @param array $optParams Optional parameters.
