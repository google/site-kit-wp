 ...
 *   $accessBindings = $analyticsadminService->properties_accessBindings;
 *  </code>
 */
class PropertiesAccessBindings extends \Google\Service\Resource
{
  /**
   ...
   * @throws \Google\Service\Exception
   */
  public function listPropertiesAccessBindings($parent, $optParams = [])
  {
    $params = ['parent' => $parent];
    $params = array_merge($params, $optParams);
...
class_alias(PropertiesAccessBindings::class, 'Google_Service_GoogleAnalyticsAdmin_Resource_PropertiesAccessBindings');
