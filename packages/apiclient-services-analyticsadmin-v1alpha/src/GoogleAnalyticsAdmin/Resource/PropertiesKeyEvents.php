...
use Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaKeyEvent;
use Google\Service\GoogleAnalyticsAdmin\GoogleAnalyticsAdminV1alphaListKeyEventsResponse;
...
class PropertiesKeyEvents extends \Google\Service\Resource
{
   ...
   * @param GoogleAnalyticsAdminV1alphaKeyEvent $postBody
   * @param array $optParams Optional parameters.
   * @return GoogleAnalyticsAdminV1alphaKeyEvent
   * @throws \Google\Service\Exception
   */
  public function create($parent, GoogleAnalyticsAdminV1alphaKeyEvent $postBody, $optParams = [])
  {
    $params = ['parent' => $parent, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
    return $this->call('create', [$params], GoogleAnalyticsAdminV1alphaKeyEvent::class);
  }
  /**
  ...
  public function get($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], GoogleAnalyticsAdminV1alphaKeyEvent::class);
  }
  /**
   ...
   * @return GoogleAnalyticsAdminV1alphaListKeyEventsResponse
   * @throws \Google\Service\Exception
   */
  public function listPropertiesKeyEvents($parent, $optParams = [])
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], GoogleAnalyticsAdminV1alphaListKeyEventsResponse::class);
  }
  /**
   ...
   * @throws \Google\Service\Exception
   */
  public function patch($name, GoogleAnalyticsAdminV1alphaKeyEvent $postBody, $optParams = [])
  {
    $params = ['name' => $name, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
    return $this->call('patch', [$params], GoogleAnalyticsAdminV1alphaKeyEvent::class);
  }
}
