...
class GoogleAnalyticsAdminV1alphaDataRedactionSettings extends \Google\Collection
{
...
class_alias(GoogleAnalyticsAdminV1alphaDataRedactionSettings::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaDataRedactionSettings');
