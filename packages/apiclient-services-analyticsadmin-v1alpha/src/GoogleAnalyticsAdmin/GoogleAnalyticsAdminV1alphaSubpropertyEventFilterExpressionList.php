...
class GoogleAnalyticsAdminV1alphaSubpropertyEventFilterExpressionList extends \Google\Collection
{
...
class_alias(GoogleAnalyticsAdminV1alphaSubpropertyEventFilterExpressionList::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaSubpropertyEventFilterExpressionList');
