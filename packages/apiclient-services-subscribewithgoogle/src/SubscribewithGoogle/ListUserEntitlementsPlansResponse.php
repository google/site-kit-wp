...
class ListUserEntitlementsPlansResponse extends \Google\Collection
{
...
class_alias(ListUserEntitlementsPlansResponse::class, 'Google_Service_SubscribewithGoogle_ListUserEntitlementsPlansResponse');
