 ...
 *
 * @since 1.153.0
 * @since 1.178.0 Add names of types that should be ignored to the `allowedNames` array, and check against that in this function to determine if an identifier should be ignored.
 *
