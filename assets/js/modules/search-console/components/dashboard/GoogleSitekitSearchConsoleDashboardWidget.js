			...
			<div className="googlesitekit-module-page googlesitekit-module-page--search-console">
				<div className="mdc-layout-grid">
					<div className="mdc-layout-grid__inner">
						...
						{ ! receivingData && (
							error ? getDataErrorComponent( 'search-console', _x( 'Search Console', 'Service name', 'google-site-kit' ), error, true, true, true, errorObj ) : getNoDataComponent( _x( 'Search Console', 'Service name', 'google-site-kit' ), true, true, true )
						) }
