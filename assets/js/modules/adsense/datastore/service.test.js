	...
	describe( 'selectors', () => {
		describe( 'getServiceURL', () => {
			...
			it( 'adds forward slashes around the path', () => {
				...
				const serviceURLWithTrailingSlash = registry.select( STORE_NAME ).getServiceURL( { path: 'test/path/to/deeplink/' } );
				expect( serviceURLWithTrailingSlash ).toEqual( expectedURL );
