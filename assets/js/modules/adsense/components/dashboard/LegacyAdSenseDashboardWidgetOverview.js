		...
		<div className="googlesitekit-adsense-performance-overview">
			<DataBlock
				...
				change={ calculateChange(
					previousTotals.cells[ 0 ].value,
					totals.cells[ 0 ].value
				) }
				changeDataUnit="%"
				context="button"
			...
			<DataBlock
				...
				change={ calculateChange(
					previousTotals.cells[ 1 ].value,
					totals.cells[ 1 ].value
				) }
				changeDataUnit="%"
				context="button"
			...
			<DataBlock
				...
				change={ calculateChange(
					previousTotals.cells[ 2 ].value,
					totals.cells[ 2 ].value
				) }
				changeDataUnit="%"
				context="button"
