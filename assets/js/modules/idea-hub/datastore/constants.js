...
export const IDEA_HUB_ACTIVITY_IS_PROCESSING = 'IDEA_HUB_ACTIVITY_IS_PROCESSING';
export const IDEA_HUB_ACTIVITY_CREATING_DRAFT = 'IDEA_HUB_ACTIVITY_CREATING_DRAFT';
export const IDEA_HUB_ACTIVITY_DRAFT_CREATED = 'IDEA_HUB_ACTIVITY_DRAFT_CREATED';
