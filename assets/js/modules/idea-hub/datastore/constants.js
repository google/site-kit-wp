...
export const IDEA_HUB_GA_CATEGORY_WIDGET = 'idea_hub_widget';
export const IDEA_HUB_GA_CATEGORY_DASHBOARD = 'idea_hub_dashboard';
export const IDEA_HUB_GA_CATEGORY_WPDASHBOARD = 'idea_hub_wpdashboard';
export const IDEA_HUB_GA_CATEGORY_POSTS = 'idea_hub_posts';
