...
describe( 'modules/ads settings', () => {
	...
	describe( 'validateCanSubmitChanges', () => {
		...
		it( 'should throw if the given customer ID is invalid', () => {
			registry.dispatch( MODULES_ADS ).receiveGetSettings( {
				conversionID: 'AW-12345',
			} );

			registry.dispatch( MODULES_ADS ).setCustomerID( 12345 );
		...
		it( 'should throw if the given external customer ID is invalid', () => {
			registry.dispatch( MODULES_ADS ).receiveGetSettings( {
				conversionID: 'AW-12345',
				customerID: '12345',
			} );

			registry.dispatch( MODULES_ADS ).setExtCustomerID( 12345 );
		...
		it( 'should throw if the given formatted external customer ID is invalid', () => {
			registry.dispatch( MODULES_ADS ).receiveGetSettings( {
				conversionID: 'AW-12345',
				customerID: '12345',
				extCustomerID: '12345',
			...
			registry.dispatch( MODULES_ADS ).setFormattedExtCustomerID( 12345 );
		...
		it( 'should throw if the given formatted user ID is invalid', () => {
			registry.dispatch( MODULES_ADS ).receiveGetSettings( {
				conversionID: 'AW-12345',
				customerID: '12345',
				extCustomerID: '12345',
				formattedExtCustomerID: '12345',
			} );

			registry.dispatch( MODULES_ADS ).setUserID( 12345 );
		...
		it( 'should throw if the given account overview URL is invalid', () => {
			registry.dispatch( MODULES_ADS ).receiveGetSettings( {
				conversionID: 'AW-12345',
				customerID: '12345',
				extCustomerID: '12345',
			...
			registry
				.dispatch( MODULES_ADS )
				.setAccountOverviewURL( 'https://example.com/' );
