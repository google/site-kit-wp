...
class AnalyticsSetup extends Component {
	...
	renderForm() {
		...
		const disabledProperty = ! isEditing || parseInt( selectedAccount, 10 ) < 1 || ! selectedAccount || ( existingTag && selectedProperty );
		const disabledProfile = ! isEditing || ~~selectedProperty < 1;
