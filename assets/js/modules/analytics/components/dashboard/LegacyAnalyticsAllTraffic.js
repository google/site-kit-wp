...
class LegacyAnalyticsAllTraffic extends Component {
	...
	getErrorDataComponent() {
		...
		if ( ! receivingData ) {
			return error ? getDataErrorComponent( 'analytics', error, true, true, true, errorObj ) : getNoDataComponent( _x( 'Analytics', 'Service name', 'google-site-kit' ), true, true, true );
		}
