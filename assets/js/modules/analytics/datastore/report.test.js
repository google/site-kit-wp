...
describe( 'modules/analytics report', () => {
	const analyticsRegexp = /^\/google-site-kit\/v1\/modules\/analytics\/data\/report/;
	let registry;
	...
	describe( 'selectors', () => {
		describe( 'getReport', () => {
			...
			it( 'uses a resolver to make a network request', async () => {
				fetchMock.getOnce( analyticsRegexp, {
