/**
 * Reader Revenue Manager Newsletter CTA preview - Inline pane.
 *
...
export default function InlinePane( {
	ctaTitle,
	ctaBody,
	consentEnabled,
	consentText,
	...
	return (
		<div className="googlesitekit-rrm-newsletter-preview googlesitekit-rrm-newsletter-preview--inline">
			<Typography
				as="p"
				type="body"
				size="small"
