/**
 * TopAuthorsDrivingLeadsWidget component stories.
 *
...
interface TopAuthorsDrivingLeadsWidgetStoryArgs {
	setupRegistry: (
...
function Template( {
	setupRegistry,
	...args
}: TopAuthorsDrivingLeadsWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/TopAuthorsDrivingLeadsWidget',
	component: TopAuthorsDrivingLeadsWidget,
	decorators: [
		(
			Story: ComponentType,
			{ args }: { args: TopAuthorsDrivingLeadsWidgetStoryArgs }
		) => {
