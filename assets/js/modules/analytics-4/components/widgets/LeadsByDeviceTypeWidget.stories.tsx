/**
 * LeadsByDeviceTypeWidget component stories.
 *
...
const WidgetWithComponentProps = withWidgetComponentProps(
	'kmAnalyticsLeadsByDeviceType'
)( LeadsByDeviceTypeWidget );

interface LeadsByDeviceTypeWidgetStoryArgs {
	setupRegistry: (
...
function Template( {
	setupRegistry,
	...args
}: LeadsByDeviceTypeWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/LeadsByDeviceTypeWidget',
	decorators: [
		(
			Story: ComponentType,
			{ args }: { args: LeadsByDeviceTypeWidgetStoryArgs }
		) => {
