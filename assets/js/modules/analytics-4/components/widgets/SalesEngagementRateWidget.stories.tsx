/**
 * SalesEngagementRateWidget component stories.
 *
...
interface SalesEngagementRateWidgetStoryArgs {
	setupRegistry: (
...
function Template( {
	setupRegistry,
	...args
}: SalesEngagementRateWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/SalesEngagementRateWidget',
	decorators: [
		(
			Story: ComponentType,
			{ args }: { args: SalesEngagementRateWidgetStoryArgs }
		) => {
