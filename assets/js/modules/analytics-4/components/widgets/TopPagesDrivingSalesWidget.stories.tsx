/**
 * TopPagesDrivingSalesWidget component stories.
 *
...
interface TopPagesDrivingSalesWidgetStoryArgs {
	setupRegistry: (
...
function Template( {
	...
	viewContext,
	...args
}: TopPagesDrivingSalesWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/TopPagesDrivingSalesWidget',
	decorators: [
		(
			Story: ComponentType,
			{ args }: { args: TopPagesDrivingSalesWidgetStoryArgs }
		) => {
