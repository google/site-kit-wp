/**
 * TotalSalesWidget component stories.
 *
...
interface TotalSalesWidgetStoryArgs {
	setupRegistry: (
		registry: Parameters< typeof provideModules >[ 0 ]
	) => void;
}

function Template( { setupRegistry, ...args }: TotalSalesWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/TotalSalesWidget',
	decorators: [
		(
			Story: ComponentType,
			{ args }: { args: TotalSalesWidgetStoryArgs }
		) => {
