/**
 * SalesByVisitorTypeWidget component stories.
 *
...
interface SalesByVisitorTypeWidgetStoryArgs {
	setupRegistry: (
...
function Template( {
	setupRegistry,
	...args
}: SalesByVisitorTypeWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/SalesByVisitorTypeWidget',
	decorators: [
		(
			Story: ComponentType,
			{ args }: { args: SalesByVisitorTypeWidgetStoryArgs }
		) => {
