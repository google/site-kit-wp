/**
 * FormCompletionRateWidget component stories.
 *
...
interface FormCompletionRateWidgetStoryArgs {
	setupRegistry: (
...
function Template( {
	setupRegistry,
	...args
}: FormCompletionRateWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/FormCompletionRateWidget',
	decorators: [
		(
			Story: ComponentType,
			{ args }: { args: FormCompletionRateWidgetStoryArgs }
		) => {
