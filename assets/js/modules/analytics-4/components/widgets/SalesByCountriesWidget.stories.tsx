/**
 * SalesByCountriesWidget component stories.
 *
...
interface SalesByCountriesWidgetStoryArgs {
	setupRegistry: (
...
function Template( {
	setupRegistry,
	...args
}: SalesByCountriesWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/SalesByCountriesWidget',
	decorators: [
		(
			Story: ComponentType,
			{ args }: { args: SalesByCountriesWidgetStoryArgs }
		) => {
