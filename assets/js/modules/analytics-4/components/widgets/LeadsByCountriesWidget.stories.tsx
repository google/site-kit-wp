/**
 * LeadsByCountriesWidget component stories.
 *
...
const WidgetWithComponentProps = withWidgetComponentProps(
	'kmAnalyticsLeadsByCountries'
)( LeadsByCountriesWidget );

interface LeadsByCountriesWidgetStoryArgs {
	setupRegistry: (
...
function Template( {
	setupRegistry,
	...args
}: LeadsByCountriesWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/LeadsByCountriesWidget',
	decorators: [
		(
			Story: ComponentType,
			{ args }: { args: LeadsByCountriesWidgetStoryArgs }
		) => {
