/**
 * TopTrafficChannelsDrivingSalesRateWidget component stories.
 *
...
interface TopTrafficChannelsDrivingSalesRateWidgetStoryArgs {
	setupRegistry: (
...
function Template( {
	setupRegistry,
	...args
}: TopTrafficChannelsDrivingSalesRateWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/TopTrafficChannelsDrivingSalesRateWidget',
	decorators: [
		(
			Story: ComponentType,
			{
				...
				args: TopTrafficChannelsDrivingSalesRateWidgetStoryArgs;
			}
		) => {
