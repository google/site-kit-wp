/**
 * TopTrafficChannelsDrivingFormCompletionRateWidget component stories.
 *
...
interface TopTrafficChannelsDrivingFormCompletionRateWidgetStoryArgs {
	setupRegistry: (
...
function Template( {
	setupRegistry,
	...args
}: TopTrafficChannelsDrivingFormCompletionRateWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/TopTrafficChannelsDrivingFormCompletionRateWidget',
	decorators: [
		(
			Story: ComponentType,
			{
				...
				args: TopTrafficChannelsDrivingFormCompletionRateWidgetStoryArgs;
			}
		) => {
