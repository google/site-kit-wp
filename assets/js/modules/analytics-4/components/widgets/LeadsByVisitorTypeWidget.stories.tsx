/**
 * LeadsByVisitorTypeWidget component stories.
 *
...
interface LeadsByVisitorTypeWidgetStoryArgs {
	setupRegistry: (
...
function Template( {
	setupRegistry,
	...args
}: LeadsByVisitorTypeWidgetStoryArgs ) {
	return (
...
export default {
	title: 'Key Metrics/LeadsByVisitorTypeWidget',
	decorators: [
		(
			Story: ComponentType,
			{ args }: { args: LeadsByVisitorTypeWidgetStoryArgs }
		) => {
