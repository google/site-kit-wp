/**
 * SalesByVisitorTypeWidget component.
 *
...
interface SalesByVisitorTypeWidgetProps {
	Widget: ElementType;
}
...
const SalesByVisitorTypeWidget: FC< SalesByVisitorTypeWidgetProps > = ( {
	Widget,
} ) => {
	...
	const rows = GOAL_DRIVER_ROW_MAPPERS[ GOAL_DRIVER_IDS.VISITOR_TYPE ](
		report?.rows || []
	);
	...
	return (
		<MetricTileTable
			Widget={ Widget }
			widgetSlug={ KM_ANALYTICS_SALES_BY_VISITOR_TYPE }
			loading={ loading }
