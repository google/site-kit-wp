/**
 * TopTrafficChannelsRateGoalDriver component stories.
 *
...
type TopTrafficChannelsRateGoalDriverStoryProps = GoalDriverComponentProps;

export default {
	title: 'Modules/Analytics4/Components/Site Goals/GoalDriverTiles/TopTrafficChannelsRate',
...
function Template( props: TopTrafficChannelsRateGoalDriverStoryProps ) {
	return <TopTrafficChannelsRateGoalDriver { ...props } />;
}
