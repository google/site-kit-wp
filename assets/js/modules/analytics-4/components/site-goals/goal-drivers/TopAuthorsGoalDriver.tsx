...
const AUTHOR_DIMENSION = 'customEvent:googlesitekit_post_author';
...
const TopAuthorsGoalDriver: FC< GoalDriverComponentProps > = ( {
	...
	const title =
		goalType === GOAL_TYPES.ECOMMERCE
			? __( 'Top authors driving sales', 'google-site-kit' )
			: __( 'Top authors driving leads', 'google-site-kit' );
