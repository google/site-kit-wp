...
const STEPS = {
	authentication: {
		...
		required: true,
		isApplicable: () => true,
		isCompleted: ( props ) => props.isSiteKitConnected && props.authenticated && ! props.needReauthenticate,
	...
	verification: {
		...
		required: true,
		isApplicable: () => true,
		isCompleted: ( props ) => props.isSiteKitConnected && props.authenticated && props.isVerified,
	...
	seachConsoleProperty: {
		...
		required: true,
		isApplicable: () => true,
		isCompleted: ( props ) => props.isSiteKitConnected && props.authenticated && props.isVerified && props.hasSearchConsoleProperty,
