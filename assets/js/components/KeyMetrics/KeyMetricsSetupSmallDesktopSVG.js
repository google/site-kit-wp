...
const LazyDesktopGraphicSVG = lazy( () =>
	import( '../../../svg/graphics/key-metrics-setup-cta-small-desktop.svg' )
);

export default function KeyMetricsSetupSmallDesktopSVG() {
	return (
