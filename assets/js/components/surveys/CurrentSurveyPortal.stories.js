...
import CurrentSurveyPortal from './CurrentSurveyPortal';

const Template = ( args ) => <CurrentSurveyPortal { ...args } />;

export const CurrentSurveyStory = Template.bind( {} );
CurrentSurveyStory.storyName = 'CurrentSurveyPortal';

export default {
	title: 'Components/Surveys/CurrentSurveyPortal',
	decorators: [
		( Story ) => {
