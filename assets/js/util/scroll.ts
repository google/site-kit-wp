 ...
 */
export function getNavigationalScrollTop(
	selector: string,
	breakpoint: string
): number {
 ...
 */
export function getStickyHeaderHeight( breakpoint: string ): number {
 ...
 */
export function getWordPressAdminBarHeight( breakpoint: string ): number {
 ...
 */
function getGoogleSiteKitHeaderHeight( breakpoint: string ): number {
 ...
 */
export function getStickyHeaderHeightWithoutNav( breakpoint: string ): number {
	let headerHeight = 0;
