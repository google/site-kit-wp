...
export function calculateChange(
	...
	function isZero( value: number | string ) {
 ...
 */
export function validateJSON( stringToValidate: string ): boolean {
	try {
 ...
 */
export function decodeHTMLEntity( str?: string | null ): string {
	if ( ! str ) {
		return '';
	}
