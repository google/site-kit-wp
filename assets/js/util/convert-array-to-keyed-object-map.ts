 ...
 */
export function convertArrayListToKeyedObjectMap<
	T extends Record< string, unknown >
>( arrayData: T[], propertyKey: keyof T & string ): Record< string, T > {
	return arrayData.reduce< Record< string, T > >( ( acc, item ) => {
		return { ...acc, [ String( item[ propertyKey ] ) ]: item };
	}, {} );
}
