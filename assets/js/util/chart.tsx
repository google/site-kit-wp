...
interface ChartReportRow {
	metrics?: Array< { values?: Array< string | number > } >;
}

interface ChartReportData {
	rows?: ChartReportRow[];
	totals?: Array< { values?: Array< string | number > } >;
}

type ChartReport = Array< { data?: ChartReportData } >;
