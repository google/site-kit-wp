...
describe( 'asyncRequire* utilities', () => {
	...
	describe( 'asyncRequire', () => {
		...
		it.each( [
			[ 'foo', 'fn returns foo', true, (): string => 'foo' ],
			[ 'foo', 'fn returns bar', false, (): string => 'bar' ],
			[ true, 'fn returns string true', false, (): string => 'true' ],
			[ null, 'fn returns false', false, (): boolean => false ],
		] )(
