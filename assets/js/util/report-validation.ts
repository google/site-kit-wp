...
export function isValidStringsOrObjects(
	...
	verifyObjectFunction: ( obj: object ) => boolean,
	verifyStringFunction: ( str: string ) => boolean = () => true
): boolean {
 ...
 */
export function isValidOrders(
	orders: OrderDefinition | OrderDefinition[]
): boolean {
	function isValidOrder( order: OrderDefinition ): boolean {
