...
describe( 'core/user utils', () => {
	...
	describe( 'getPreviousWeekDate', () => {
		...
		it( 'should go back 7 days with daysBefore value of 0 and date of "2020-01-30"', () => {
			expect( getPreviousWeekDate( '2020-01-30', 0 ) ).toEqual( '2020-01-23' );
		} );
		it( 'should go back 6 days with daysBefore value of 1 and date of "2020-01-30"', () => {
			expect( getPreviousWeekDate( '2020-01-30', 1 ) ).toEqual( '2020-01-23' );
		} );
		it( 'should go back 5 days with daysBefore value of 2 and date of "2020-01-30"', () => {
			expect( getPreviousWeekDate( '2020-01-30', 2 ) ).toEqual( '2020-01-23' );
		} );
		it( 'should go back 4 days with daysBefore value of 3 and date of "2020-01-30"', () => {
			expect( getPreviousWeekDate( '2020-01-30', 3 ) ).toEqual( '2020-01-23' );
		} );
		it( 'should go back 3 days with daysBefore value of 4 and date of "2020-01-30"', () => {
			expect( getPreviousWeekDate( '2020-01-30', 4 ) ).toEqual( '2020-01-23' );
		} );
		it( 'should go back 2 days with daysBefore value of 5 and date of "2020-01-30"', () => {
			expect( getPreviousWeekDate( '2020-01-30', 5 ) ).toEqual( '2020-01-23' );
		} );
		it( 'should go back 1 days with daysBefore value of 6 and date of "2020-01-30"', () => {
			expect( getPreviousWeekDate( '2020-01-30', 6 ) ).toEqual( '2020-01-23' );
		} );
		it( 'should go back 0 days with daysBefore value of 7 and date of "2020-01-30"', () => {
			expect( getPreviousWeekDate( '2020-01-30', 7 ) ).toEqual( '2020-01-23' );
		} );
		it( 'should go back 6 days with daysBefore value of 8 and date of "2020-01-30"', () => {
			expect( getPreviousWeekDate( '2020-01-30', 8 ) ).toEqual( '2020-01-16' );
		} );
		it( 'should go back 5 days with daysBefore value of 9 and date of "2020-01-30"', () => {
			expect( getPreviousWeekDate( '2020-01-30', 9 ) ).toEqual( '2020-01-16' );
		} );
	} );
} );
