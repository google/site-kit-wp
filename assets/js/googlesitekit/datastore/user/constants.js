...
export const KM_ANALYTICS_TOTAL_FORM_COMPLETIONS =
	'kmAnalyticsTotalFormCompletions';
export const KM_ANALYTICS_FORM_COMPLETION_RATE =
	'kmAnalyticsFormCompletionRate';
export const KM_ANALYTICS_FORM_COMPLETION_ENGAGEMENT_RATE =
	'kmAnalyticsFormCompletionEngagementRate';
export const KM_ANALYTICS_TOP_TRAFFIC_CHANNELS_DRIVING_FORM_COMPLETION_RATE =
	'kmAnalyticsTopTrafficChannelsDrivingFormCompletionRate';
export const KM_ANALYTICS_LEADS_BY_VISITOR_TYPE =
	'kmAnalyticsLeadsByVisitorType';
export const KM_ANALYTICS_LEADS_BY_COUNTRIES = 'kmAnalyticsLeadsByCountries';
export const KM_ANALYTICS_LEADS_BY_DEVICE_TYPE = 'kmAnalyticsLeadsByDeviceType';
export const KM_ANALYTICS_TOP_AUTHORS_DRIVING_LEADS =
	'kmAnalyticsTopAuthorsDrivingLeads';
