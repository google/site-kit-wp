	...
	describe( 'selectors', () => {
		describe( 'getGoogleLocaleAwareURL', () => {
			it( 'should return the correct URL', () => {
				const url = registry.select( CORE_SITE ).getGoogleLocaleAwareURL( {
		...
		describe( 'getGooglePrivacyPolicyURL', () => {
			it( 'should return the correct privacy policy URL', () => {
				const url = registry.select( CORE_SITE ).getGooglePrivacyPolicyURL();
		...
		describe( 'getGoogleSupportURL', () => {
			it.each( [
				...
				const url = registry.select( CORE_SITE ).getGoogleSupportURL( args );
			...
			it( 'should return the path with a predefined locale', () => {
				...
				const url = registry.select( CORE_SITE ).getGoogleSupportURL( { path: '/analytics/answer/1032415' } );
